...
class FRUIT:
    ...
    def draw_fruit3(self):
        ...
        fruit_rect3 = pygame.Rect(
            int(self.pos.x * cell_size), int(self.pos.y * cell_size), cell_size, cell_size)
        screen.blit(sandia, fruit_rect3)
        clock.tick(100)
...
class MAIN:
    ...
    def __init__(self):
        ...
        self.numero = 0
        # Problema con generación de manzanas, no aparecen
        self.random = np.random.randint(1, 5)
        self.snake = SNAKE()
        self.fruit = FRUIT()
    ...
    def draw_elements(self):
        frutas = [self.fruit.draw_fruit2,
                  self.fruit.draw_fruit3, self.fruit.draw_fruit4]
        ...
        if FRUIT.numero % 5 == 1:
            ...
            print("1")
        elif FRUIT.numero % 9 == 1:
            self.fruit.draw_fruit3()
            print("2")
        elif FRUIT.numero % 4 == 1:
...
sandia = pygame.image.load(
    'Graficos_despues_15pt/SandiaMc.png').convert_alpha()
...
pescado = pygame.image.load(
    'Graficos_despues_15pt/PescadoMc.png').convert_alpha()
